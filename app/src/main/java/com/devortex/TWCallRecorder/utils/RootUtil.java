...
public class RootUtil {
    ...
    private Shell.OnCommandResultListener commandResultListener = new Shell.OnCommandResultListener() {
        @Override
    ...
    private void waitForCommandFinished() {
        ...
        if (mLastExitCode == Shell.OnCommandResultListener.WATCHDOG_EXIT
                || mLastExitCode == Shell.OnCommandResultListener.SHELL_DIED)
            dispose();
    }
